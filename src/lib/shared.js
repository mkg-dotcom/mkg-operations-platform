...
export async function loadWorkspace(userId){
 const [{data:profile,error:profileError},{data:offices,error:officeError},{data:profiles,error:peopleError},{data:memberships,error:membershipError},{data:tasks,error:taskError},{data:notifications,error:noticeError}]=await Promise.all([
